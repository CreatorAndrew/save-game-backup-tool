    ...
    def main(self):
        ...
        if no_gui:
            ...
            if config_path is not None:
                self.backup_configs.append(BackupConfig(name="Single Config", path=config_path, interval=interval))
            ...
            while config_path is None:
                ...
                if choice == "start":
                    ...
                    if config not in self.configs_used:
                        ...
                        self.backup_configs.append(BackupConfig(config["name"], config["file"], True, interval))
