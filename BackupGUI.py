...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.0.4 on Fri Oct 13 15:26:43 2023
#
...
class BackupGUI(wx.Frame):
    def __init__(self, *args, **kwds):
        # begin wxGlade: BackupGUI.__init__
    ...
    def handle_button(self, event):  # wxGlade: BackupGUI.<event_handler>
...
# end of class BackupGUI

class GUI(wx.App):
    def OnInit(self):
        self.frame = BackupGUI(None, wx.ID_ANY, "")
